...
const identifyExercises: IdentifyPointsExercise[] = [
  // ─── Dropdown-Intervall-Aufgaben: Extremstellen als Bounds, alle Intervalle bestimmen ───
  {
    id: 'mono-id-01',
    ...
    correctIntervals: [
      { from: '-\u221e', to: -1, type: 'smw' },
      { from: -1, to: 1, type: 'smf' },
      { from: 1, to: '+\u221e', type: 'smw' },
    ],
    feedbackExplanation: 'HP bei x = \u22121, TP bei x = 1. f steigt auf (\u2212\u221e, \u22121) und (1, \u221e), f\u00e4llt auf (\u22121, 1).',
  },
  {
    id: 'mono-id-02',
    type: 'identify-points',
    ...
    correctIntervals: [
      { from: '-\u221e', to: -2, type: 'smw' },
      { from: -2, to: 2, type: 'smf' },
      { from: 2, to: '+\u221e', type: 'smw' },
    ],
    feedbackExplanation: 'HP bei x = \u22122, TP bei x = 2. f steigt auf (\u2212\u221e, \u22122) und (2, \u221e), f\u00e4llt auf (\u22122, 2).',
  },
  {
    id: 'mono-id-03',
    type: 'identify-points',
    ...
    correctIntervals: [
      { from: '-\u221e', to: -1, type: 'smf' },
      { from: -1, to: 1, type: 'smw' },
      { from: 1, to: '+\u221e', type: 'smf' },
    ],
    feedbackExplanation: 'TP bei x = \u22121, HP bei x = 1. f f\u00e4llt auf (\u2212\u221e, \u22121) und (1, \u221e), steigt auf (\u22121, 1).',
  },
  {
    id: 'mono-id-04',
    type: 'identify-points',
    ...
    correctIntervals: [
      { from: '-\u221e', to: 1, type: 'smw' },
      { from: 1, to: 3, type: 'smf' },
      { from: 3, to: '+\u221e', type: 'smw' },
    ],
    feedbackExplanation: 'HP bei x = 1, TP bei x = 3. f steigt auf (\u2212\u221e, 1) und (3, \u221e), f\u00e4llt auf (1, 3).',
  },
  {
    id: 'mono-id-05',
    type: 'identify-points',
    ...
    correctIntervals: [
      { from: '-\u221e', to: 1, type: 'smf' },
      { from: 1, to: 3, type: 'smw' },
      { from: 3, to: '+\u221e', type: 'smf' },
    ],
    feedbackExplanation: 'TP bei x = 1, HP bei x = 3. f f\u00e4llt auf (\u2212\u221e, 1) und (3, \u221e), steigt auf (1, 3).',
  },
  // ─── Sachkontext: nur das streng monotone Intervall finden ───
  {
    id: 'mono-id-06',
    type: 'identify-points',
    module: 'monotonie',
    ...
    targetType: 'monoton-steigend',
    prompt: 'In welchem Intervall ist v streng monoton steigend?',
    targets: [],
    intervalBounds: [0, 3, 5],
    includeInfinity: false,
    intervalCount: 1,
    correctIntervals: [
      { from: 0, to: 3, type: 'smw' },
    ],
    feedbackExplanation: 'v steigt streng auf (0, 3). Ab t = 3 bleibt v konstant bei 30 \u2014 dort ist v nur monoton, nicht streng monoton steigend.',
    strictFollowUp: {
      isStrict: true,
      explanation: 'Ja! Auf (0, 3) nimmt v \u00fcberall echt zu \u2014 das ist streng monoton steigend. Auf dem gr\u00f6\u00dferen Intervall [0, 5] w\u00e4re v nur monoton steigend (wegen des Plateaus ab t = 3).',
    },
  },
  {
    id: 'mono-id-07',
    ...
    prompt: 'In welchem Intervall ist T streng monoton fallend?',
    targets: [],
    intervalBounds: [0, 4, 5],
    includeInfinity: false,
    intervalCount: 1,
    correctIntervals: [
      { from: 0, to: 4, type: 'smf' },
    ],
    feedbackExplanation: 'T f\u00e4llt streng auf (0, 4). Ab t = 4 ist T konstant bei 18 l.',
    strictFollowUp: {
      isStrict: true,
      explanation: 'Ja! Auf (0, 4) nimmt T \u00fcberall echt ab. Auf [0, 5] w\u00e4re T nur monoton fallend (Plateau ab t = 4).',
    },
  },
  {
    id: 'mono-id-08',
    ...
    feedbackExplanation: 'f(x) = x\u00b3 ist auf ganz \u211d streng monoton steigend \u2014 auch bei x = 0, wo f\u2019(0) = 0.',
    strictFollowUp: {
      isStrict: true,
...
// ─── K2: Zwei-Phasen — Extremstellen finden, dann Intervalle klassifizieren ───

const twoPhaseExercises: IdentifyPointsExercise[] = [
  {
    id: 'mono-k2-01',
    type: 'identify-points',
    module: 'monotonie',
  ...
  },
  {
    ...
    feedbackExplanation: 'f(x) = x\u00b3 \u00e4ndert sein Monotonieverhalten nirgends \u2014 f ist auf ganz \u211d streng monoton steigend, auch bei x = 0.',
    extremaOptions: {
      xValues: [-2, -1, 0, 1, 2],
      correctIndices: [],
      prompt: 'An welchen Stellen \u00e4ndert f ihr Monotonieverhalten? W\u00e4hle alle aus \u2014 oder keine, falls f \u00fcberall gleich verl\u00e4uft.',
    },
  },
];
